...
You MUST use the '${WriteTodosTool.Name}' tool as needed for each task based on the complexity of the task. You should start with analyzing if you need this tool at the beginning of each task. This is the tool that should be used to plan out what needs to happen in clear and modular fashion. 
