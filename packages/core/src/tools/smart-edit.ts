...
4. **Literal Match:** 'old_string' must be an exact, whitespace-precise match of the current file content. Read the file first.`,
      Kind.Edit,
      {
        properties: {
          ...
          instruction: {
            description:
              "A concise summary of the change (e.g., 'Fixing null pointer'). Used for auditing.",
            type: 'string',
          },
          old_string: {
            description:
              'The exact text block to be replaced. Must include sufficient surrounding context to be unique. Do not include code that should not be changed.',
            type: 'string',
          },
          new_string: {
            description:
