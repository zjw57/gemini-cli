...
vi.mock('../tools/tool-registry', async () => {
...
describe('Server Config (config.ts)', async () => {
  ...
  describe('Usage Statistics', async () => {
  ...
  describe('Telemetry Settings', async () => {
  ...
  describe('UseRipgrep Configuration', async () => {
