...
export function isBinary(
  ...
  // it's likely binary. This threshold is a heuristic chosen to be lenient
  // enough for TTY output, which can contain many ANSI control codes, while
  // still reliably detecting most binary file types.
